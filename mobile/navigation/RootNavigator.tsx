...
import FitmaxDashboardScreen from '../screens/fitmax/FitmaxDashboardScreen';
        ...
        >
            {!isAuthenticated ? (
                ...
                <>
                    ...
                    <Stack.Screen name="FitmaxDashboard" component={FitmaxDashboardScreen} options={{ headerShown: false }} />
                </>
            )}
        </Stack.Navigator>
    );
